...
HD_PWD='C:/Users/nlao2/lab3_example/lab3_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_example.tcl -notrace
