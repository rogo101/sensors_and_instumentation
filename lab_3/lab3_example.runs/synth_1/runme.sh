...
HD_PWD='C:/Users/nlao2/lab3_example/lab3_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_example.tcl
